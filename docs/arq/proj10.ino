const int ldr = A0; //declara a variável "ldr" como tipo int, ligada na porta analógica A0 do arduino
...
valor =  analogRead(ldr);//lê e atribui à variável "valor" o valor do ldr
